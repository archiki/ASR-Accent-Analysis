...
* **Section 3.2, Information Mixing Analysis:** Datapoints for the figures showing phone focus and neighbour analysis can be found in `Contribution.ipynb`. `Deepspeech/test_contr.py` is used to calculate the gradient contributions given by *equation (1)*. <img src="https://render.githubusercontent.com/render/math?math=e^{i \pi} = -1">

* **Section 4, Mutual Information Experiments:**
