...
class DeepSpeech(nn.Module):
	...
	def forward(self, x, lengths, store_rep = False):
		...
		x.retain_grad()
		return x, output_lengths, y1, r1, r2, r3, r4, r5
...
if __name__ == '__main__':
	...
	print("DeepSpeech version: ", model.module.version)
	print("")
	print("Recurrent Neural Network Properties")
	print("  RNN Type:         ", model.module.rnn_type.__name__.lower())
	print("  RNN Layers:       ", model.module.hidden_layers)
	print("  RNN Size:         ", model.module.hidden_size)
	print("  Classes:          ", len(model.module.labels))
	print("")
	print("Model Features")
	print("  Labels:           ", model.labels)
	print("  Sample Rate:      ", model.module.audio_conf.get("sample_rate", "n/a"))
	print("  Window Type:      ", model.module.audio_conf.get("window", "n/a"))
	print("  Window Size:      ", model.module.audio_conf.get("window_size", "n/a"))
	print("  Window Stride:    ", model.module.audio_conf.get("window_stride", "n/a"))
